...
##Plot_2
with(feb_subset,plot(Global_active_power~datetime,type="l",main="plot 2"))

##plot voltage and datetime
with(feb_subset,plot(Voltage~datetime, main = "Voltage plot",type="l"))
...
#plot Global_reactive_power and datetime
with(feb_subset,plot(Global_reactive_power~datetime,type="l",main="Global reactive power"))
